...
public class Client extends JFrame implements Runnable {
	...
	public Client(String name, String address, int port) {
		...
		txtrMessage.getInputMap(JComponent.WHEN_FOCUSED).put(newLineKeyStroke, newLineKeyStrokeAndKey);
	...
	private void processMessage(String message) {
		try {
			...
			String timeStamp = new SimpleDateFormat("MMM dd @ hh:mm:ss aaa").format(Calendar.getInstance().getTime());
